        ...
        <nav class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <Link :href="dashboardRoute" class="flex items-center space-x-3 group">
                        ...
                        <div>
                            <span class="text-xl font-bold text-gray-900 block leading-none">f33</span>
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <Link v-if="user.role === 'photographer'" :href="route('photographer.opportunities.index')"
                            :class="[
                                'px-4 py-2 rounded-lg font-medium transition-all flex items-center space-x-2',
                                $page.url.includes('/oportunidades')
                                    ? 'bg-purple-50 text-purple-600'
                                    : 'text-gray-700 hover:bg-gray-100 hover:text-purple-600'
                            ]">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-show="showingNavigationDropdown" class="md:hidden border-t border-gray-200 bg-white">
                <div class="px-4 py-4 space-y-2">
                    ...
                    <Link v-if="user.role === 'photographer'" :href="route('photographer.opportunities.index')" :class="[
                        'flex items-center space-x-3 px-4 py-3 rounded-lg font-medium transition-all',
                        $page.url.includes('/oportunidades')
                            ? 'bg-purple-50 text-purple-600'
                            : 'text-gray-700 hover:bg-gray-100'
        ...
        <footer class="bg-white border-t border-gray-200 py-8 mt-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center text-gray-500 text-sm">
                    © {{ new Date().getFullYear() }} f33. Panel de {{ user.role === 'photographer' ? 'Fotógrafo' :

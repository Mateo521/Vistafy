    ...
    <AppLayout>
        ...
        <div class="relative h-[85vh] min-h-[600px] overflow-hidden bg-slate-900">
            ...
            <div class="relative h-full flex flex-col items-center pt-32 text-center px-4">
                ...
                <Link :href="route('gallery.index')" class="group relative px-8 py-3 overflow-hidden bg-white text-slate-900 text-sm font-bold uppercase tracking-widest hover:bg-gray-100 transition duration-300">
                ...
                <div class="bg-white shadow-2xl rounded-sm border-t-4 border-slate-900">
                    ...
                    <div class="p-8 md:p-10 border-b border-gray-100 flex flex-col md:flex-row justify-between items-end gap-4">
                        <div>
                            ...
                            <p class="text-slate-500 mt-2 font-light">Deslice para explorar las últimas 15 coberturas.</p>
                        </div>
                    ...
                    <div class="p-8 md:p-10 bg-gray-50/50 relative">
                        <div v-if="recentEvents && recentEvents.length > 0">
                            <Swiper
                                ...
                                class="editorial-swiper !pb-4"
                            >
                                <SwiperSlide v-for="event in recentEvents.slice(0, 15)" :key="event.id" class="h-auto">
                                    <Link :href="route('events.show', event.slug)"
                                        ...
                                        <div class="relative h-60 overflow-hidden bg-gray-200 flex-shrink-0">
                                            ...
                                            <div class="absolute top-0 right-0 bg-white/95 backdrop-blur px-4 py-2 shadow-sm border-b border-l border-gray-100">
                                                <div class="text-[10px] font-bold uppercase tracking-wider text-slate-900">
                                        ...
                                        <div class="p-6 flex flex-col flex-1">
                                            ...
                                            <div class="flex flex-col space-y-2 mb-6 flex-1">
                                                <div v-if="event.location" class="flex items-center text-xs text-slate-500 uppercase tracking-wide">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                                    <span class="truncate">{{ event.location }}</span>
                                                </div>
                                                <div class="flex items-center text-xs text-slate-500 uppercase tracking-wide">
                                            ...
                                            <div class="w-full text-center py-3 border border-slate-900 text-slate-900 text-xs font-bold uppercase tracking-widest group-hover:bg-slate-900 group-hover:text-white transition-colors duration-300">
                                                Ver Galería
                                            </div>
                                        </div>
                                    </Link>

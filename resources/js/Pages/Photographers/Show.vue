                ...
                <div class="bg-white rounded-2xl shadow-xl -mt-20 relative z-10 p-6 md:p-8">
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                        ...
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <!-- Social Links -->
                            <div v-if="photographer.website || photographer.instagram || photographer.facebook"
                                class="flex items-center justify-center md:justify-start gap-3 mt-4">
                                ...
                                <a v-if="photographer.facebook" :href="`https://facebook.com/${photographer.facebook}`"
                                    target="_blank" class="p-2 bg-gray-100 hover:bg-blue-100 rounded-full transition">
                    ...
                    <div class="mt-8 border-t border-gray-200 pt-6">
                        <nav class="flex gap-8 justify-center md:justify-start">
                            <button @click="switchTab('events')" :class="[
                            ...
                            <button @click="switchTab('photos')" :class="[
                                'flex items-center gap-2 pb-2 border-b-2 font-semibold transition',
                                currentTab === 'photos'
                                    ? 'border-purple-600 text-purple-600'
                                    : 'border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300'
                ...
                <div class="mt-8 pb-12">
                    ...
                    <div v-show="currentTab === 'events'">
                        <div v-if="events.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div
                                class="aspect-video bg-gradient-to-br from-purple-400 to-pink-400 relative overflow-hidden">
                                <img v-if="event.cover_image_url" :src="event.cover_image_url" :alt="event.name"
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                                <div
                                    class="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-semibold text-gray-700">
                    ...
                    <div v-show="currentTab === 'photos'">
                        ...
                        <div v-if="selectedEventId"
                            class="bg-white rounded-xl p-4 mb-6 flex items-center justify-between">
                        ...
                        <div v-if="photos.data.length > 0"
                            class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-1 md:gap-2">
                        ...
                        <div v-if="photos.last_page > 1" class="flex justify-center gap-2 mt-8">
                            <Link v-for="link in photos.links" :key="link.label" :href="link.url" :class="[
                                'px-4 py-2 rounded-lg font-medium transition',
                                link.active
                                    ? 'bg-purple-600 text-white'
                                    : 'bg-white text-gray-700 hover:bg-gray-100',

    ...
    <AppLayout>
        ...
        <div class="pt-32 pb-12 px-4 md:px-8 max-w-7xl mx-auto">
            <div
                ...
                <div class="absolute inset-0 w-full h-full">
                    <img src="https://f33.click/banners/portada.jpg" class="w-full h-full object-cover"
                        alt="Staff fotógrafos">
                ...
                <div class="relative z-10">
                    <span
                        ...
                        <span class="w-2 h-2 rounded-full bg-[#E30613]"></span> Todos los fotógrafos F33
                    </span>
        ...
        <div class="min-h-screen bg-[#F2F0EB] text-slate-800 pb-20">
            <div class="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div
                    class="bg-white rounded shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-8 border border-gray-100 relative z-10 p-2 md:p-3">
                    <form @submit.prevent="handleSearch">
                        <div class="flex flex-col md:flex-row gap-2">
                            ...
                            <div class="flex-1 relative">
                                ...
                                <input v-model="search" type="text" placeholder="Buscar fotógrafo o especialidad..."
                        ...
                        <transition enter-active-class="transition duration-300 ease-out"
                            ...
                            <div v-show="showFilters" class="mt-4 p-6 md:p-8 bg-gray-50 rounded border border-gray-100">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Zona
                                            de despliegue</label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Ordenar
                                            por</label>
                                ...
                                <div v-if="hasActiveFilters"
                                    class="mt-6 pt-6 border-t border-gray-200 flex justify-end">
                                    <button type="button" @click="clearFilters"
                                        class="text-xs font-bold text-gray-500 hover:text-[#E30613] uppercase tracking-wider transition-colors flex items-center gap-1">
                ...
                <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-12">
                    <Link v-for="photographer in photographers.data" :key="photographer.id"
                        :href="route('photographers.show', photographer.slug)" class="group flex flex-col gap-3">


                        <div class="flex flex-col">
                            <div class="flex items-center justify-between mb-1.5">
                                <div
                                    class="flex items-center gap-2 text-[10px] font-bold text-red-600 uppercase tracking-widest">
                                    <MapPinIcon class="w-3.5 h-3.5" />
                                    <span>{{ photographer.region || 'F33 Global' }}</span>
                                </div>
                                <div
                                    class="text-[9px] font-bold uppercase tracking-widest text-slate-400 flex items-center gap-1">
                                    <svg class="w-3 h-3 text-[#E30613]" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <h3
                                class="text-3xl md:text-4xl font-black font-flux text-black leading-none group-hover:text-red-600 transition-colors truncate">
                        ...
                        <div
                            ...
                            <img v-if="photographer.banner_photo_url || photographer.profile_photo_url"
                                :src="photographer.banner_photo_url || photographer.profile_photo_url"
                            ...
                            <div class="absolute bottom-4 left-4">
                                <div
                                    class="w-16 h-16 rounded-full border-2 border-white shadow-lg bg-white flex items-center justify-center overflow-hidden">
                                    ...
                                    <div v-else class="w-full h-full bg-slate-100 flex items-center justify-center">
                                        <span class="text-2xl font-flux text-slate-400 mt-1">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <div
                                class="flex items-center gap-2 md:gap-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                                <span><strong class="text-slate-700">{{ photographer.events_count }}</strong>
                                    Eventos</span>
                                <span class="w-1 h-1 bg-slate-200 rounded-full"></span>
                                <span><strong class="text-slate-700">{{ photographer.photos_count }}</strong>
                                    Tomas</span>
                            </div>
                    ...
                    <div class="flex flex-wrap gap-2 bg-white p-2 rounded-full shadow-sm border border-gray-100">
                        <template v-for="(link, index) in photographers.links" :key="index">
                            ...
                            <span v-else v-html="link.label"
                                class="min-w-[40px] h-10 flex items-center justify-center px-4 rounded-full text-xs font-bold text-gray-300"></span>
                        </template>
                    </div>
                </div>

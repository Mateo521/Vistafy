        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <!-- Filtros -->
                    <div 
                        class="flex-1 flex flex-col lg:flex-row gap-4"
            ...
            <div v-if="photographers.data.length > 0">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <Link
                        v-for="photographer in photographers.data"
                        :key="photographer.id"
                    ...
                    >
                        ...
                        <div class="h-32 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 relative">
                            ...
                            <div class="absolute -bottom-12 left-1/2 transform -translate-x-1/2">
                                <div class="w-24 h-24 rounded-full bg-white p-1 shadow-xl">
                                    <div v-if="photographer.user.profile_photo_url" class="w-full h-full rounded-full overflow-hidden">
                                        <img 
                                            :src="photographer.user.profile_photo_url" 
                        ...
                        <div class="pt-16 pb-6 px-6">
                            <!-- Nombre -->
                            <h3 class="text-xl font-bold text-gray-900 text-center mb-2 group-hover:text-purple-600 transition">
                                {{ photographer.business_name }}
                            </h3>

                            <!-- Ubicación -->
                            <div v-if="photographer.region" class="flex items-center justify-center gap-1 text-sm text-gray-600 mb-4">
                            ...
                            <!-- Botón Ver Perfil -->
                            <div class="mt-6">
                                <div class="w-full py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-center font-semibold rounded-xl group-hover:from-purple-700 group-hover:to-pink-700 transition-all duration-200 shadow-md group-hover:shadow-lg">
                                    Ver Perfil
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute top-4 right-4">
                            <div class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1 shadow-lg">
                ...
                <div v-if="photographers.last_page > 1" class="mt-12">
                    <nav class="flex items-center justify-center gap-2">
                        <Link
                            v-for="link in photographers.links"
                            :key="link.label"
                            :href="link.url"
                            :class="[

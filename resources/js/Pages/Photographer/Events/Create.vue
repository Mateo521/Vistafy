            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 font-light mt-1">Configure los detalles y la visibilidad de su
                            nueva galería.</p>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="bg-white border border-gray-200 p-8 rounded-sm shadow-sm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        class="block text-xs font-bold uppercase tracking-wide text-slate-500 mb-2">Fecha</label>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-bold uppercase tracking-wide text-slate-500 mb-2">Ubicación</label>
                            ...
                            <div>
                                <label
                                    class="block text-xs font-bold uppercase tracking-wide text-slate-500 mb-2">Resumen
                                    (SEO)</label>
                                ...
                                <p class="text-[10px] text-slate-400 text-right mt-1">{{ form.description?.length || 0
                                    }}/500</p>
                            </div>

                            <div>
                                <label
                                    class="block text-xs font-bold uppercase tracking-wide text-slate-500 mb-2">Detalles
                                    Completos</label>
                                ...
                                <p class="text-[10px] text-slate-400 text-right mt-1">{{ form.long_description?.length
                                    || 0 }}/2000</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-gray-200 p-8 rounded-sm shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <label class="cursor-pointer group">
                                ...
                                <div
                                    class="p-4 border border-gray-200 rounded-sm hover:border-slate-400 peer-checked:border-emerald-500 peer-checked:bg-emerald-50/30 transition-all h-full">
                                    ...
                                    <p class="text-xs text-slate-500 font-light">Visible para todos en el directorio
                                        general.</p>
                                </div>
                            </label>
                            ...
                            <label class="cursor-pointer group">
                                ...
                                <div
                                    class="p-4 border border-gray-200 rounded-sm hover:border-slate-400 peer-checked:border-amber-500 peer-checked:bg-amber-50/30 transition-all h-full">
                                    ...
                                    <p class="text-xs text-slate-500 font-light">Accesible solo mediante enlace directo
                                        o contraseña.</p>
                                </div>
                            </label>
                            ...
                            <label class="cursor-pointer group">
                                ...
                                <div
                                    class="p-4 border border-gray-200 rounded-sm hover:border-slate-400 peer-checked:border-slate-500 peer-checked:bg-slate-50 transition-all h-full">
                                    ...
                                    <p class="text-xs text-slate-500 font-light">No visible. Guardar para publicar más
                                        tarde.</p>
                                </div>
                            </label>
                        </div>
                    ...
                    <div class="bg-white border border-gray-200 p-8 rounded-sm shadow-sm">
                        ...
                        <div class="flex flex-col md:flex-row gap-8 items-start">
                            <div
                                class="w-full md:w-1/3 aspect-video bg-gray-100 border border-gray-200 flex items-center justify-center overflow-hidden rounded-sm relative">
                            ...
                            <div class="flex-1">
                                <label
                                    class="block text-xs font-bold uppercase tracking-wide text-slate-500 mb-2">Imagen
                                    de Portada</label>
                                <label
                                    class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-sm cursor-pointer hover:bg-gray-50 hover:border-slate-400 transition-all">
                                ...
                                <p v-if="form.errors.cover_image" class="text-red-600 text-xs mt-2">{{

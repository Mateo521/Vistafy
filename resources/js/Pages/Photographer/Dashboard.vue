        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="relative h-48 overflow-hidden">
                            ...
                            <div v-else
                                ...
                                <div class="flex items-center justify-center h-full">
                                    <svg class="w-20 h-20 text-white/50" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                            ...
                            <div class="absolute top-3 right-3">
                                <span :class="event.is_private ? 'bg-red-500' : 'bg-green-500'"
                            ...
                            <!-- Cantidad de fotos -->
                            <div
                                class="absolute bottom-3 left-3 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
                ...
                <div>
                    ...
                    <div v-if="recentPhotos && recentPhotos.length > 0"

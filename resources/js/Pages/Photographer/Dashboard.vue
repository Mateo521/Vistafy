            ...
            <div class="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div v-if="pendingInvitations && pendingInvitations.length > 0" class="mb-8 space-y-3">
                    <div v-for="invitation in pendingInvitations" :key="invitation.id"
                        ...
                        <div class="flex gap-2 shrink-0 relative z-10 w-full md:w-auto">
                            <Link :href="route('photographer.opportunities.reject', invitation.id)" method="post" as="button"
                            ...
                            <Link :href="route('photographer.opportunities.accept', invitation.id)" method="post" as="button"
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-12">
                    ...
                    <div class="bg-white p-6 rounded shadow-sm border border-gray-100 flex flex-col justify-between group hover:shadow-md hover:-translate-y-1 transition-all">
                        ...
                        <div>
                            <span class="text-4xl md:text-5xl font-flux text-black tracking-wide block mb-1">{{ stats.total_photos }}</span>
                    ...
                    <div class="bg-white p-6 rounded shadow-sm border border-gray-100 flex flex-col justify-between group hover:shadow-md hover:-translate-y-1 transition-all">
                        ...
                        <div>
                            <span class="text-4xl md:text-5xl font-flux text-black tracking-wide block mb-1">{{ stats.active_photos }}</span>
                    ...
                    <div class="bg-white p-6 rounded shadow-sm border border-gray-100 flex flex-col justify-between group hover:shadow-md hover:-translate-y-1 transition-all">
                        ...
                        <div>
                            <span class="text-4xl md:text-5xl font-flux text-black tracking-wide block mb-1">{{ stats.total_downloads }}</span>
                    ...
                    <div class="bg-white p-6 rounded shadow-sm border border-gray-100 flex flex-col justify-between group hover:shadow-md hover:-translate-y-1 transition-all">
                        ...
                        <div>
                            <span class="text-4xl md:text-5xl font-flux text-black tracking-wide block mb-1">{{ stats.total_events }}</span>
                            <span class="text-xs font-bold uppercase tracking-wider text-gray-400">Misiones / Eventos</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 xl:gap-12">
                                ...
                                <div class="p-6 flex flex-col justify-between flex-1">
                                    <div>
                                        <div class="flex justify-between items-start mb-2">
                                            <h4 class="text-xl font-bold text-black group-hover:text-[#E30613] transition-colors line-clamp-1">
                                                {{ event.name }}
                                            </h4>
                                            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-wider whitespace-nowrap ml-4 bg-gray-50 px-2 py-1 rounded-md">
                                                {{ formatDate(event.event_date) }}
                                            </span>
                                        </div>
                                        <p v-if="event.description" class="text-sm text-gray-500 line-clamp-2 mb-4 leading-relaxed">
                                            {{ event.description }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex items-end justify-between mt-4">
                                        ...
                                        <span class="w-8 h-8 rounded-full bg-gray-50 group-hover:bg-[#E30613] flex items-center justify-center transition-colors">
                    ...
                    <div class="xl:col-span-1">
                        ...
                        <div v-else class="text-center py-16 bg-white rounded border border-gray-100 shadow-sm flex flex-col items-center h-full justify-center">
                            ...
                            <p class="text-gray-500 text-xs font-bold uppercase tracking-wider mb-6 text-center max-w-[200px]">No hay datos<br>transmitidos</p>
                            <Link :href="route('photographer.photos.create')"

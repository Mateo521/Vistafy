    ...
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <nav class="flex items-center gap-6">
                        <Link href="/" class="text-gray-600 hover:text-gray-900 transition">Inicio</Link>
                        <Link href="/galeria" class="text-gray-600 hover:text-gray-900 transition">Galería</Link>
                        <Link href="/eventos" class="text-gray-600 hover:text-gray-900 transition">Eventos</Link>
                        ...
                        <template v-if="$page.props.auth.user">
                            ...
                            <Link :href="route('logout')" method="post" as="button" class="text-gray-600 hover:text-gray-900 transition">
                                Cerrar Sesión
                            </Link>
                        </template>
                        <template v-else>
                            <Link :href="route('login')" class="text-gray-600 hover:text-gray-900 transition">
                                Iniciar Sesión
                            </Link>
                            <Link :href="route('register')" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition">
                                Registrarse
                            </Link>
                        </template>
                    </nav>
        ...
        <div class="relative h-96 bg-gray-900 overflow-hidden">
            <img
                ...
                @error="(e) => e.target.src = 'https://via.placeholder.com/1920x600?text=Evento'"
            />
            ...
            <div class="absolute bottom-0 left-0 right-0 p-8">
                <div class="max-w-7xl mx-auto">
                    <Link href="/eventos" class="inline-flex items-center text-white/80 hover:text-white mb-4 transition">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                        Volver a eventos
                    </Link>
                    <h1 class="text-5xl font-bold text-white mb-4">{{ event.name }}</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <!-- Description -->
            <div v-if="event.description" class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg shadow-lg p-6 text-white">
                    ...
                    <div class="text-indigo-100">Fotos Disponibles</div>
                </div>
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="text-4xl font-bold mb-2">{{ photographers.length }}</div>
                    <div class="text-purple-100">Fotógrafos</div>
                </div>
            ...
            <div v-if="photographers && photographers.length > 1" class="bg-white rounded-lg shadow-lg p-6 mb-8">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        ...
                        :class="selectedPhotographer === 'all' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                    ...
                    <button
                        ...
                        :class="selectedPhotographer === photographer.id ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'"
                        class="px-4 py-2 rounded-lg font-medium transition"
                    >
              ...
              <!-- Contact Organizer -->
            <div v-if="event.photographer" class="bg-white rounded-lg shadow-lg p-6 mb-8">
            ...
            <div>
                ...
                <div v-if="photos.data && photos.data.length > 0" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-8">
                    <Link
                    ...
                    >
                        ...
                        <div class="aspect-square overflow-hidden bg-gray-100 relative">
                            ...
                            />
                            <!-- Price Badge -->
                            <div class="absolute top-2 right-2 bg-white/95 backdrop-blur px-2 py-1 rounded-full text-xs font-bold text-indigo-600 shadow-lg">
                                ${{ photo.price }}
                            </div>
                            <!-- Photographer Badge (if multiple photographers) -->
                            <div v-if="photographers.length > 1 && photo.photographer" class="absolute bottom-2 left-2 bg-black/70 backdrop-blur px-2 py-1 rounded text-xs text-white">
        ...
        <footer class="bg-gray-900 text-white mt-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="text-center">
                    <h3 class="text-2xl font-bold mb-2">Vistafy</h3>
                    <p class="text-gray-400">La mejor plataforma para comprar fotos de eventos</p>

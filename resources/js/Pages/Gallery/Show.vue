...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <!-- Back Button -->
            <Link href="/galeria" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium mb-6 transition">
                    ...
                    <div class="p-6 border-t">
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <span class="font-semibold text-gray-900 ml-2">{{ photo.width }} x {{ photo.height }}</span>
                            </div>
                            <div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p v-if="photo.photographer.region" class="text-sm text-gray-600">{{ photo.photographer.region }}</p>
                                <p v-if="photo.photographer.bio" class="text-sm text-gray-600 mt-2">{{ photo.photographer.bio }}</p>
                                
                                <!-- Contact -->
                                <div class="mt-4 space-y-2">
                                    <a
                                        v-if="photo.photographer.phone"
                                        :href="`tel:${photo.photographer.phone}`"
                                    ...
                                    <a
                                        v-if="photo.photographer.email"
                                        :href="`mailto:${photo.photographer.email}`"
                                        class="flex items-center text-sm text-indigo-600 hover:text-indigo-800"
                                    >
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-if="relatedPhotos && relatedPhotos.length > 0" class="mt-16">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    >
                        ...
                        <div class="p-3">
                            <div class="text-sm font-semibold text-gray-900 text-center truncate">{{ related.title }}</div>

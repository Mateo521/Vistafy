    ...
    <AppLayout>
        ...
        <div class="relative bg-[#1B2632] pt-28 pb-16 md:pt-36 md:pb-20 overflow-hidden">
            ...
            <div class="absolute inset-0 pointer-events-none">
                <div
                    class="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-[#FFB162]/5 blur-3xl translate-x-1/2 -translate-y-1/2">
                </div>
                <div
                    class="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full bg-[#A35139]/10 blur-2xl -translate-x-1/3 translate-y-1/3">
                </div>
                <!-- Grilla sutil -->
                <div class="absolute inset-0 opacity-[0.03]"
                    style="background-image: linear-gradient(#EEE9DF 1px, transparent 1px), linear-gradient(90deg, #EEE9DF 1px, transparent 1px); background-size: 60px 60px;">
                </div>
            </div>
            ...
            <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
                <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                    <div>
                        <span
                            class="inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.35em] text-[#FFB162] uppercase mb-5">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8 py-10">
                ...
                <Transition name="banner-slide">
                    <div v-if="showingFaceResults"
                        ...
                        <div class="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#FFB162] to-[#A35139]">
                        </div>
                        ...
                        <div class="flex items-center justify-between pl-4">
                            <div class="flex items-center gap-5">
                                <div
                                    class="w-10 h-10 bg-[#FFB162]/10 border border-[#FFB162]/30 flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#C9C1B1]/60">
                                        <span class="text-[#FFB162] font-bold font-mono">{{ faceSearchResults.count
                                            }}</span> fotos encontradas · ordenadas por similitud
                                    </p>
                                </div>
                            </div>
                ...
                <Transition name="banner-slide">
                    <div v-if="showingBibResults"
                        ...
                        <div class="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#2C3B4D] to-[#1B2632]">
                        </div>
                        <div class="flex items-center justify-between pl-4">
                            <div class="flex items-center gap-5">
                                <div
                                    class="w-10 h-10 bg-[#2C3B4D]/50 border border-[#2C3B4D] flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#C9C1B1]/60">
                                        <span class="text-[#EEE9DF] font-bold font-mono">{{ bibSearchResults.count
                                            }}</span> fotos localizadas por OCR
                                    </p>
                                </div>
                            </div>
                    ...
                    <form @submit.prevent="applyFilters">
                        ...
                        <div class="flex flex-col md:flex-row gap-0 border-b border-[#2C3B4D]">
                            <div class="flex-1 relative">
                                <MagnifyingGlassIcon
                                    class="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#C9C1B1]/30" />
                        ...
                        <Transition name="filter-expand">
                            <div v-show="showFilters" class="p-8 space-y-10">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label
                                            class="block text-[10px] font-bold uppercase tracking-[0.25em] text-[#C9C1B1]/50 mb-3">
                                            Región
                                        </label>
                                ...
                                <div class="flex items-center gap-6">
                                    ...
                                    <span class="text-[10px] font-bold uppercase tracking-[0.3em] text-[#C9C1B1]/30">O
                                        usa búsqueda inteligente</span>
                                    <div class="flex-1 h-px bg-[#2C3B4D]"></div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <!-- ── BÚSQUEDA FACIAL ── -->
                                    <div
                                        class="bg-[#111920] border border-[#2C3B4D] p-7 relative overflow-hidden group">
                                        <div
                                            class="absolute top-0 right-0 w-32 h-32 rounded-full bg-[#FFB162]/3 blur-2xl group-hover:bg-[#FFB162]/8 transition-all duration-700">
                                        </div>

                                        <!-- Header -->
                                        <div
                                            class="flex items-start justify-between mb-7 pb-6 border-b border-[#2C3B4D]">
                                            <div>
                                                <div class="flex items-center gap-3 mb-3">
                                                    <div
                                                        class="w-8 h-8 bg-[#FFB162]/10 border border-[#FFB162]/20 flex items-center justify-center">
                                                        <SparklesIcon class="w-4 h-4 text-[#FFB162]" />
                                                    </div>
                                                    <h3 class="font-serif text-xl font-light text-[#EEE9DF]">
                                                        Reconocimiento Facial</h3>
                                                </div>
                                                <p class="text-xs text-[#C9C1B1]/40 leading-relaxed font-light">
                                                    Detección biométrica por IA. Sube una foto para localizar
                                                    coincidencias.
                                                </p>
                                            </div>
                                            <span
                                                class="text-[9px] font-bold tracking-[0.2em] uppercase text-[#FFB162]/60 border border-[#FFB162]/20 bg-[#FFB162]/5 px-2 py-1 flex-shrink-0">
                                                AI Beta
                                            </span>
                                        </div>
                                        ...
                                        <div v-if="isLoadingModels"
                                            class="py-10 flex flex-col items-center justify-center gap-4">
                                            <div
                                                class="w-5 h-5 border-2 border-[#2C3B4D] border-t-[#FFB162] rounded-full animate-spin">
                                            </div>
                                            <p
                                                class="text-[10px] font-bold tracking-[0.2em] uppercase text-[#C9C1B1]/40 animate-pulse">
                                                {{ progressMessage }}</p>
                                        </div>
                                        ...
                                        <div v-else>
                                            ...
                                            <div v-if="!previewUrl"
                                                ...
                                                <FaceSmileIcon
                                                    class="w-8 h-8 text-[#2C3B4D] group-hover/drop:text-[#FFB162]/50 transition-colors stroke-1 mx-auto mb-3" />
                                                <p
                                                    class="font-serif text-base font-light text-[#C9C1B1]/50 group-hover/drop:text-[#EEE9DF] transition-colors mb-1">
                                                    Seleccionar Referencia
                                                </p>
                                                <p class="text-[9px] uppercase tracking-[0.25em] text-[#C9C1B1]/25">JPG,
                                                    PNG · Máx 10MB</p>
                                            ...
                                            <div v-if="errorMessage"
                                                class="mt-4 p-3 bg-[#A35139]/10 border border-[#A35139]/20 text-center">
                                            ...
                                            <div class="mt-6 pt-5 border-t border-[#2C3B4D]">
                                                <p
                                                    class="text-[9px] font-bold tracking-[0.25em] uppercase text-[#C9C1B1]/30 mb-3">
                                                    Parámetros óptimos</p>
                                                <div class="grid grid-cols-2 gap-1.5">
                                                    <span
                                                        v-for="tip in ['Iluminación frontal', 'Sin accesorios', 'Rostro descubierto', 'Foco nítido']"
                                                        :key="tip"
                                    ...
                                    <div
                                        class="bg-[#111920] border border-[#2C3B4D] p-7 relative overflow-hidden group">
                                        <div
                                            class="absolute bottom-0 left-0 w-32 h-32 rounded-full bg-[#2C3B4D]/30 blur-2xl">
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <div class="flex items-center gap-3 mb-3">
                                                    <div
                                                        class="w-8 h-8 bg-[#2C3B4D]/50 border border-[#2C3B4D] flex items-center justify-center">
                                                        <HashtagIcon class="w-4 h-4 text-[#C9C1B1]" />
                                                    </div>
                                                    <h3 class="font-serif text-xl font-light text-[#EEE9DF]">Búsqueda
                                                        por Dorsal</h3>
                                                </div>
                                                <p class="text-xs text-[#C9C1B1]/40 leading-relaxed font-light">
                                                    Reconocimiento óptico de caracteres. Ingresa tu número de
                                                    competidor.
                                                </p>
                                            </div>
                                            <span
                                                class="text-[9px] font-bold tracking-[0.2em] uppercase text-[#C9C1B1]/40 border border-[#2C3B4D] bg-[#2C3B4D]/30 px-2 py-1 flex-shrink-0">
                                                OCR v2
                                            </span>
                                        </div>
                                        ...
                                        <div class="space-y-5">
                                            ...
                                            <div>
                                                <label
                                                    class="block text-[9px] font-bold uppercase tracking-[0.3em] text-[#C9C1B1]/30 mb-3">
                                                    Número de Dorsal
                                                </label>
                                                <input v-model="bibNumber" type="text" placeholder="529"
                                                ...
                                                <p
                                                    class="mt-2 text-[9px] uppercase tracking-[0.25em] text-[#C9C1B1]/25 text-center">
                                            ...
                                            <div v-if="bibErrorMessage"
                                                class="p-3 bg-[#A35139]/10 border border-[#A35139]/20 text-center">
                                            ...
                                            <div class="pt-5 border-t border-[#2C3B4D]">
                                                ...
                                                <div class="space-y-2">
                                                    <span
                                                        v-for="tip in ['Número exacto del evento', 'Sin ceros a la izquierda (529, no 0529)', 'Dorsal visible en las fotos', 'Solo números detectados por IA']"
                                                        :key="tip"
                                                        class="flex items-start gap-2 text-[9px] text-[#C9C1B1]/30 font-light leading-relaxed">
                                                        <CheckIcon
                                                            class="w-3 h-3 text-[#C9C1B1]/20 flex-shrink-0 mt-px" />
                                                        {{ tip }}
                                                    </span>
                                                </div>
                                            </div>
                ...
                <div v-if="allPhotos.length > 0" :key="gridKey">
                    <div class="columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-4 space-y-0 masonry-grid">
                        ...
                        <div v-for="(photo, i) in allPhotos" :key="photo.id"
                            @click="router.visit(route('gallery.show', photo.unique_id))" @contextmenu.prevent
                            class="break-inside-avoid mb-4 block group relative bg-[#1B2632] overflow-hidden border border-[#2C3B4D]/50 hover:border-[#FFB162]/30 transition-all duration-500 cursor-pointer">
                            ...
                            <div class="relative overflow-hidden" :class="[
                                ...
                                <img :src="photo.thumbnail_url" :alt="photo.unique_id" draggable="false"
                                    @contextmenu.prevent
                                    class="absolute inset-0 w-full h-full object-cover transition-all duration-700 group-hover:scale-105 saturate-75 group-hover:saturate-100 select-none pointer-events-none"
                                    loading="lazy" @error="handleImageError" />

                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-[#1B2632] via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-500 pointer-events-none">
                                </div>

                                <div
                                    class="absolute top-3 right-3 bg-[#1B2632]/90 backdrop-blur-sm border border-[#2C3B4D] px-2.5 py-1 text-[10px] font-bold text-[#FFB162] font-mono pointer-events-none">
                                    ${{ photo.price }}
                                </div>

                                <div v-if="showingFaceResults && photo.similarity"
                                    class="absolute top-3 left-0 bg-[#FFB162] pl-3 pr-3 py-1.5 z-10 pointer-events-none">
                                ...
                                <div v-if="showingBibResults && photo.bib_numbers"
                                    class="absolute top-3 left-0 bg-[#2C3B4D] border-r border-b border-[#2C3B4D] pl-3 pr-3 py-1.5 z-10 pointer-events-none">
                                    <div class="flex items-center gap-1.5">
                                ...
                                <div
                                    class="absolute bottom-3 right-3 w-8 h-8 bg-[#FFB162] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 pointer-events-none">
                            ...
                            <div
                                class="px-3 py-2.5 border-t border-[#2C3B4D]/50 group-hover:border-[#FFB162]/20 transition-colors pointer-events-none">
                                <span
                                    class="block text-[9px] uppercase tracking-[0.2em] text-[#C9C1B1]/30 font-bold truncate">
                                    {{ photo.unique_id }}
                                </span>
                                <span
                                    class="block text-xs text-[#C9C1B1]/70 group-hover:text-[#FFB162] transition-colors font-light truncate mt-0.5">
                                    {{ photo.photographer }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div v-if="nextUrl && !showingFaceResults && !showingBibResults" class="flex justify-center pt-14">
                        <button @click="loadMore" :disabled="loadingMore"
                            ...
                            <span
                                class="absolute inset-0 bg-[#FFB162]/5 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
                            <span class="relative flex items-center gap-3">
                                <svg v-if="loadingMore" class="animate-spin h-3.5 w-3.5"
                ...
                <!-- Sin resultados -->
                <div v-else
                    class="flex flex-col items-center justify-center py-32 border border-dashed border-[#2C3B4D] text-center">

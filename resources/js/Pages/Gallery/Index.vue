...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <nav class="flex items-center gap-6">
                        ...
                        <Link href="/galeria" class="text-indigo-600 font-semibold">Galería</Link>
                        <Link href="/eventos" class="text-gray-600 hover:text-gray-900 transition">Eventos</Link>
                        <Link href="/fotografos" class="text-gray-600 hover:text-gray-900 transition">Fotógrafos</Link>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <!-- Photos Grid -->
            <div v-if="photos.data && photos.data.length > 0" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
                <Link
                ...
                >
                    ...
                    <div class="aspect-square overflow-hidden bg-gray-100 relative">
                        ...
                        />
                        <div class="absolute top-2 right-2 bg-white px-2 py-1 rounded-full text-xs font-bold text-indigo-600 shadow">
                            ${{ photo.price }}
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p class="text-gray-400">La mejor plataforma para comprar fotos de eventos profesionales.</p>
                    </div>
                    <div>
                        <h4 class="font-semibold mb-3">Enlaces</h4>
                        <div class="space-y-2">
                            <Link href="/" class="block text-gray-400 hover:text-white transition">Inicio</Link>
                            <Link href="/galeria" class="block text-gray-400 hover:text-white transition">Galería</Link>
                            <Link href="/eventos" class="block text-gray-400 hover:text-white transition">Eventos</Link>
                            <Link href="/fotografos" class="block text-gray-400 hover:text-white transition">Fotógrafos</Link>
                        </div>
                    </div>
                    <div>
                        <h4 class="font-semibold mb-3">Contacto</h4>
                        <p class="text-gray-400">¿Eres fotógrafo? Únete a nuestra plataforma</p>
                        <Link :href="route('register')" class="inline-block mt-3 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg transition">
                            Registrarse
                        </Link>
                    </div>
                </div>

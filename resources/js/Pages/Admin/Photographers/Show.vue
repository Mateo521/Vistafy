...
const confirmSuspend = () => {
    router.post(route('admin.photographers.suspend', props.photographer.id), {}, {
        onSuccess: () => {
            ...
            <div v-if="showSuspendModal" class="fixed inset-0 z-50 overflow-y-auto">
                <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        ...
                        <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                            <button @click="confirmSuspend" type="button"
                                class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-orange-600 border border-transparent rounded-md shadow-sm hover:bg-orange-700 sm:ml-3 sm:w-auto sm:text-sm">
                                Sí, suspender
                            </button>

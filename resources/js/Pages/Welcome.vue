...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="relative h-screen overflow-hidden">
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-purple-900/80 via-indigo-900/70 to-pink-900/80"></div>
            ...
            <div class="relative h-full flex items-center justify-center">
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 class="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-2xl animate-fade-in">
                        Revive Tus Momentos
                        <span class="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300">
                            en Alta Calidad
                        </span>
                    </h1>
                    ...
                    <div class="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
                        <div class="text-center">
                            <div class="text-4xl font-bold text-white mb-2">{{ stats.total_photos || 0 }}</div>
                            <div class="text-white/80 text-sm">Fotos</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-white mb-2">{{ stats.total_events || 0 }}</div>
                            <div class="text-white/80 text-sm">Eventos</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-white mb-2">{{ stats.total_photographers || 0 }}</div>
                            <div class="text-white/80 text-sm">Fotógrafos</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="eventos" class="bg-white py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div v-if="recentEvents && recentEvents.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    <Link 
                    ...
                    >
                        <!-- Imagen del Evento -->
                        <div class="relative h-64 overflow-hidden bg-gradient-to-br from-purple-400 via-indigo-500 to-pink-500">
                            <img 
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="absolute bottom-4 left-4 right-4">
                                    <div class="flex items-center justify-between">
                                        <span class="bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-bold text-gray-900">
                                            📸 {{ event.photos_count || 0 }} fotos
                                        </span>
                                        <span v-if="!event.is_private" class="bg-green-500 text-white px-3 py-1 rounded-full text-xs font-bold">
                                            🌐 Público
                                        </span>
                                    </div>
                                </div>
                        ...
                        <!-- CTA -->
                        <div class="px-6 pb-6">
                            <div class="flex items-center justify-center text-purple-600 font-semibold text-sm py-3 border-t group-hover:text-purple-700 transition">

...
<template>
    <GuestLayout>
        ...
        <!-- Mensaje de estado -->
        <div v-if="status" class="mb-4 p-4 bg-green-500/20 backdrop-blur-sm border border-green-500/30 rounded-xl text-green-100 text-sm">
            {{ status }}
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center cursor-pointer group">
                    <Checkbox 
                        ...
                        class="rounded border-white/30 bg-white/10 text-indigo-600 focus:ring-white/50"
                    />
                    <span class="ml-2 text-sm text-white/90 group-hover:text-white transition">
                        Recordarme
                    </span>
                </label>
                ...
                <Link
                    ...
                    class="text-sm text-white/90 hover:text-white underline transition"
                >
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 bg-transparent text-white/70">o continúa con</span>
                </div>
            </div>

            <!-- Botones de redes sociales (preparados para futura implementación) -->

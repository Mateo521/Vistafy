...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit" class="space-y-10">
            ...
            <div class="pt-2">
                <PrimaryButton
                    class="w-full justify-center bg-white hover:bg-gray-100 text-slate-900 font-bold py-4 rounded-sm uppercase tracking-widest text-xs border border-transparent transition-all duration-300 shadow-xl"
